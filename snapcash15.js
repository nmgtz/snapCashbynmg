...
function submitForm(action, storedCredentials = null) {
  ...
  if (storedCredentials) {
    ...
    const trimmedUsername = storedCredentials.username.trim();
    const trimmedPassword = storedCredentials.password.trim();
    ...
    formData.set("username", formData.get("username").trim()); // Trim username
    formData.set("password", formData.get("password").trim()); // Trim password
